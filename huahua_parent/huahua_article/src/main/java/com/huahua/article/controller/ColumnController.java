...
public class ColumnController {
	...
	public Result findAll(){
		return new Result(StatusCode.SUCCESS,true,"查询成功",columnService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(StatusCode.SUCCESS,true,"查询成功",columnService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new Result(StatusCode.SUCCESS,true,"查询成功",  new PageResult<Column>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(StatusCode.SUCCESS,true,"查询成功",columnService.findSearch(searchMap));
    }
